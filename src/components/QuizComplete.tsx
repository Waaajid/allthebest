...
const QuizComplete = () => {
  ...
  const finalResults = teamScores.length > 0 
    ? [...teamScores].sort((a, b) => b.roundsWon.length - a.roundsWon.length)
    : [];
  const winningTeam = finalResults.length > 0 ? finalResults[0] : null;
  ...
  return (
    <div className="w-full max-w-4xl">
      <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl shadow-lg mb-8">
